		...
		const messages: OpenAI.ChatCompletionMessageParam[] = [
			{
        		...
        		- Переводи заголовок (title) так, чтобы он точно соответствовал смыслу описания (description), а не дословно. Он должен быть естественным и привлекательным для носителей языка.
